...
1. **Undistortion**: `MoildevApplicator` perfectly flattens the image before it reaches the AI or ArUco detectors.
...
A common concern is: _If a cup is much wider (larger diameter) but has the same physical height, won't the system think it's taller because the bounding box is bigger?_

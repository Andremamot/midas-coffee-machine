...
| **Calibration Model** | 1-Point K-Factor (K=0.00000) |
...
| **Tray Anchor Depth (Z)** | 24.49 cm | Average physical depth of the tray. |
| **Minimum / Maximum Height** | 0.00 / 0.00 cm | Extremes recorded. |
| **Total Frames / Inferences** | 101 / 90 | Pipeline tracking efficiency. |
